  ...
  <div class="w-11/12 mx-auto flex flex-col md:flex-row items-center gap-10 px-5">
    <div class="text-section md:w-1/2">
      ...
      <p class="text-lg text-gray-700 mb-4">
        Welcome to <strong>Blog Heaven</strong>, your go-to platform for insightful and engaging content on Blogs. We aim to empower readers with up-to-date knowledge and inspire meaningful conversations.
      </p>
      <p class="text-lg text-gray-700 mb-4">
        Founded in 2024, <strong>Blog Heaven</strong> started as a passion project to connect like-minded individuals through storytelling and knowledge sharing.
      </p>
      <p class="text-lg text-gray-700 mb-4">
        Join us as we explore topics that matter to you. Together, let's learn, grow, and inspire!
      </p>
      <button onClick={()=>{
