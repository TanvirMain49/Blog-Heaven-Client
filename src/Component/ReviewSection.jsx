...
const ReviewSection = () => {
  return (
    <div className="w-10/12 mx-auto pb-16">
      ...
      <p className="md:text-lg text-sm text-center text-gray-600 italic mb-12 dark:text-white">
        Hear what your favorite celebrities have to say about our website!
        Trusted by the stars, loved by everyone.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {/* Emma Watson */}
        <div className="bg-gray-100 rounded-lg p-6 shadow-lg hover:translate-y-2 transform transition duration-300 dark:bg-black">
          <img
          ...
          <p className="text-gray-700 text-center mt-2 italic dark:text-white">
